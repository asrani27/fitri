   ...
   <div class="row">
    <div class="col-md-12">
        <div class="box box-warning">
            ...
            <form class="form-horizontal" action="/superadmin/anakjalanan/edit/{{$data->id}}" method="post">
                @csrf
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      ...
                      <a href="/superadmin/anakjalanan" class="btn bg-gray btn-block"><i class="fa fa-arrow-left"></i> Kembali</a>
                    </div>
                  </div>
              </div>
            </form>
